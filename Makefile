...
SRC = src/main.c src/libs/ioutils/mcu_io.c src/libs/uart/uart.c src/libs/utils/strutils.c src/libs/shifter/sipo_shifter.c \
		...
		src/libs/utils/millis.c src/libs/utils/crc.c src/libs/interface/xmodem.c \
		src/libs/interface/data_buffer.c
...
CINCS = -Isrc/libs/ -Isrc/libs/ioutils/ -Isrc/libs/uart/ -Isrc/libs/utils/ -Isrc/libs/shifter/ -Isrc/libs/pal_types
